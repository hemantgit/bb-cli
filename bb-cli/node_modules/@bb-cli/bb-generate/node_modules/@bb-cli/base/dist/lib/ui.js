'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _inquirer=require('inquirer');var _inquirer2=_interopRequireDefault(_inquirer);var _safe=require('colors/safe');var _safe2=_interopRequireDefault(_safe);var _cliTable=require('cli-table');var _cliTable2=_interopRequireDefault(_cliTable);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/**
 ...
 */var defaultTheme={silly:'rainbow',input:'grey',verbose:'cyan',prompt:'grey',info:['green','underline'],data:'grey',help:'cyan',warn:'yellow',debug:'blue',error:'red',// custom
heading:['white','bold']};colors.setTheme(defaultTheme);var defaultTableOptions={chars:{top:'═','top-mid':'╤','top-left':'╔','top-right':'╗',bottom:'═','bottom-mid':'╧','bottom-left':'╚','bottom-right':'╝',left:'║','left-mid':'╟',mid:'─','mid-mid':'┼',right:'║','right-mid':'╢',middle:'│'},style:{'padding-left':2,'padding-right':2,head:['white','bold'],border:['white'],compact:false}};var table=function table(options){return new _cliTable2.default(Object.assign({},options,defaultTableOptions));};/**
 * User Interface for the terminal (Prompting / Styles / Spinners / Progress)
 * @module ui
 * @type {object}
 */exports.default={prompt:prompt,colors:colors,table:table};
